<header aria-label="Site Header" class="bg-black py-2">
  <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between">
      <div class="flex-1 md:flex md:items-center md:gap-12">
        ...
        <img
          src="https://github.com/unifiedorg/.github/blob/main/img/logo-banner.png?raw=true"
          alt="Unified Banner"
          width="128"
          height="64"
          >
      ...
      <div class="md:flex md:items-center md:gap-12">
        ...
        <div class="flex items-center gap-4">
          <div class="sm:flex sm:gap-4">
            ...
            <div class="hidden sm:flex">
              <a
                ...
                >
              <span
                class="absolute inset-0 border border-current"
                ></span>
              <span
          ...
          <div class="block md:hidden">
            <button
              class="rounded bg-white p-2 text-black transition hover:text-gray-800"
              >
              <svg
