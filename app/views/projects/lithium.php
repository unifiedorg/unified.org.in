    ...
    <div
      ...
      <div class="mx-auto max-w-xl text-center">
        ...
        <div class="mt-8 flex flex-wrap justify-center gap-4">
          <a href="/project/lithium/docs" class="relative inline-flex items-center justify-center inline-block p-4 px-5 py-3 overflow-hidden font-medium text-indigo-600 rounded-lg shadow-2xl group">
